...
public class Score {
    ...
    public void setRoundCutOffScore(int roundCutOffScore) {
        this.roundCutOffScore = roundCutOffScore;
    }
...
//        window.fillRect(xPos, yPos - 10, xPos + 100, yPos + 50);
    ...
    public int getRoundCutOffScore() {
        return roundCutOffScore;
    }

    public void reset() {
        setScore(0);
        setRoundCutOffScore(0);
    }
